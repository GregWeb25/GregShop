...
import { ICommentItemProps } from "./types/TypesComents";

const CommentItem = observer(({comment, setAnswerId, update}: ICommentItemProps) => {
    ...
    return(
        <div>
            ...
            <div className="row d-flex justify-content-end">
                <CommentChild update={update} setAnswerId={setAnswerId}  id={comment.id}/>
            </div>
            <Confirming
                show={confirming}
