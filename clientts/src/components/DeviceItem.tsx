...
import { IDeviceItemProps } from "./types/TypesComponents";

const DeviceItem = observer(({device, deleteFunction}: IDeviceItemProps) => {
    ...
    const deleteConfirming = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) =>{
        e.stopPropagation();
        setConfirming(true);
    }
